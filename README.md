<h1 align="center">📆 Calendar-Scheduler</h1>
...
- 최초 접속 시 보여지는 화면
- 현재 날짜에 맞는 달력을 표시 및 오늘 날짜는 빨간색 원으로 표시
...
- 등록된 전체 일정을 오름차순 정렬
- 선택한 일정을 삭제할 수 있고, 등록된 일정이 없을 시 창을 종료
